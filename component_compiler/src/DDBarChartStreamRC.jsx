...
const componentExplanation =
	"This is a DynDash Component that takes in Sources that hold Streams of Numbers, in order to turn them into Bar Charts generated through Recharts.";
...
const renderComponent = (uuid, data, slotSettings) => {
	...
	let elements = valueKeys.map((key) => {
